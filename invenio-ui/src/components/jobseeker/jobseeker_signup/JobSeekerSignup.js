...
class JobSeekerSignup extends Component {
    ...
    handleSubmit = (event) => {
        ...
        axios
            .post("http://localhost:5001/invenio/jobseekers", this.state.jobSeekerModel)
            .then((response) => {
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="row mb-2">
                        <div className="col">
                            <input
                                onChange={this.handleChange}
                                value={this.state.jobSeekerModel.telephone}
                                name="telephone"
                                type="text"
                                className="form-control"
                    ...
                    <div class="form-group">
                        <p>Already registered? <Link to="/jobseeker-login">Sign In</Link></p>
                    </div>
                    <button
                        type="submit"
